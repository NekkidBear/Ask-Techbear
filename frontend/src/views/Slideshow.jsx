    ...
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center px-16">
      ...
      >
        ...
        <div className="bg-gray-800 rounded-2xl p-8 mb-6">
          ...
          {/* Fluid Typography Applied to Question Text 👇 */}
          <p className="text-white leading-relaxed text-[clamp(1.25rem,2.2vw,1.5rem)]">
        ...
        <div className="bg-cyan-950 border-2 border-cyan-500 rounded-2xl p-8">
          ...
          {/* Fluid Typography Applied to Answer Text 👇 */}
          <p className="text-white leading-relaxed whitespace-pre-wrap text-[clamp(1.1rem,1.8vw,1.35rem)]">
            {displayText}
          </p>
        </div>
